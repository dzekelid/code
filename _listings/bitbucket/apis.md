...
- name: Bitbucket Get Snippets Username Encoded  Revision Diff
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/code/master/_listings/bitbucket/snippets-username-encoded-id-revision-diff-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/code/master/_listings/bitbucket/snippets-username-encoded-id-revision-diff-get-postman.md
x-common:
- type: x-developer
