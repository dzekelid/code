...
- name: Bitbucket Update Snippets Username Encoded  Comments Comment
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/code/master/_listings/bitbucket/snippets-username-encoded-id-comments-comment-id-put.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/code/master/_listings/bitbucket/snippets-username-encoded-id-comments-comment-id-put-postman.md
x-common:
- type: x-developer
