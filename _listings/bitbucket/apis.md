...
- name: Bitbucket Parameters Snippets Username Encoded  Watch
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/code/master/_listings/bitbucket/snippets-username-encoded-id-watch-parameters.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/code/master/_listings/bitbucket/snippets-username-encoded-id-watch-parameters-postman.md
x-common:
- type: x-developer
