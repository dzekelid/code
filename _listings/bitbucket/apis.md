...
- name: Bitbucket Parameters Snippets Username Encoded  Revision Patch
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/code/master/_listings/bitbucket/snippets-username-encoded-id-revision-patch-parameters.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/code/master/_listings/bitbucket/snippets-username-encoded-id-revision-patch-parameters-postman.md
x-common:
- type: x-developer
