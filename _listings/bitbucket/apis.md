...
- name: Bitbucket Delete Snippets Username Encoded
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/code/master/_listings/bitbucket/snippets-username-encoded-id-delete.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/code/master/_listings/bitbucket/snippets-username-encoded-id-delete-postman.md
x-common:
- type: x-developer
