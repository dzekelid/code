...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/code/master/_listings/logicbroker/apis.md
...
- name: CommerceAPI - Gets a new SSCC18 container code.
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/code/master/_listings/logicbroker/apiv1shipmentscontainercode-get-openapi.md
- name: CommerceAPI - Return the current status code of an invoice.
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/code/master/_listings/logicbroker/apiv1invoiceslogicbrokerkeystatus-get-openapi.md
x-common:
- type: x-blog-rss
