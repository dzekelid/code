...
- name: AWS Code Pipeline API - Put Action Revision
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/code/master/_listings/aws-code-pipeline/actionputactionrevision-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/code/master/_listings/aws-code-pipeline/actionputactionrevision-get-openapi.md
- name: AWS Code Pipeline API - Put Approval Result
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/code/master/_listings/aws-code-pipeline/actionputapprovalresult-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/code/master/_listings/aws-code-pipeline/actionputapprovalresult-get-openapi.md
x-common:
- type: x-api-gallery
