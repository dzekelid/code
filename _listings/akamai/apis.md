...
- name: Akamai API Get Event&#8217;s Requests
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/code/master/_listings/akamai/events-v2-accountid-events-eventid-trafficdata-cpcode-requests-get.md
x-common:
- type: x-base
