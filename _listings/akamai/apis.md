...
- name: Akamai API Get Edge Bandwidth per CP Code
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/code/master/_listings/akamai/events-v2-accountid-events-eventid-trafficdata-cpcode-edge-bandwidth-cpcode-get.md
x-common:
- type: x-base
