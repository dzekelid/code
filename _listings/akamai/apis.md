...
- name: Akamai API Get Event&#8217;s Status Totals per CP Code
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/code/master/_listings/akamai/events-v2-accountid-events-eventid-trafficdata-cpcode-edge-status-cpcode-get.md
x-common:
- type: x-base
