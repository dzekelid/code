...
- name: Akamai API List Regions per Country
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/code/master/_listings/akamai/config-media-security-v1-security-regions-countrycode-get.md
x-common:
- type: x-base
